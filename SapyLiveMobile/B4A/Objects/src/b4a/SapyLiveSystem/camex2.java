...
public class camex2 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.SapyLiveSystem.camex2");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.SapyLiveSystem.camex2.class).invoke(this, new Object[] {null});
        else
...
public String  _camera_previewcapturecomplete(Object _captureresult) throws Exception{
 //BA.debugLineNum = 309;BA.debugLine="Private Sub Camera_PreviewCaptureComplete (Capture";
 //BA.debugLineNum = 310;BA.debugLine="FocusState = IntToConst(GetFromCaptureResult(Capt";
...
anywheresoftware.b4j.object.JavaObject _session = null;
 //BA.debugLineNum = 73;BA.debugLine="Private Sub CloseSession";
 //BA.debugLineNum = 74;BA.debugLine="Dim session As JavaObject = jcamera.GetFieldJO(\"c";
_session = new anywheresoftware.b4j.object.JavaObject();
_session = _jcamera.GetFieldJO("captureSession");
 //BA.debugLineNum = 75;BA.debugLine="If session.IsInitialized Then";
if (_session.IsInitialized()) { 
 //BA.debugLineNum = 76;BA.debugLine="session.RunMethod(\"stopRepeating\", Null)";
_session.RunMethod("stopRepeating",(Object[])(__c.Null));
 //BA.debugLineNum = 77;BA.debugLine="session.RunMethod(\"abortCaptures\", Null)";
_session.RunMethod("abortCaptures",(Object[])(__c.Null));
 //BA.debugLineNum = 78;BA.debugLine="jcamera.SetField(\"captureSession\", Null)";
...
public ResumableSub_CreateSurface(b4a.SapyLiveSystem.camex2 parent) {
this.parent = parent;
}
b4a.SapyLiveSystem.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 145;BA.debugLine="If tv.IsInitialized Then tv.RemoveView";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 146;BA.debugLine="tv = Camera.CreateSurface";
parent._tv = parent._camera.CreateSurface(ba);
 //BA.debugLineNum = 147;BA.debugLine="mPanel.AddView(tv, 0, 0, mPanel.Width, mPanel.Hei";
parent._mpanel.AddView((android.view.View)(parent._tv.getObject()),(int) (0),(int) (0),parent._mpanel.getWidth(),parent._mpanel.getHeight());
 //BA.debugLineNum = 148;BA.debugLine="tv.SendToBack";
parent._tv.SendToBack();
 //BA.debugLineNum = 149;BA.debugLine="Wait For Camera_SurfaceReady";
...
public ResumableSub_FocusAndTakePicture(b4a.SapyLiveSystem.camex2 parent,int _mytaskindex) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 272;BA.debugLine="Dim PreviewFocusMode As String = AF_MODE.Get(GetF";
_previewfocusmode = BA.ObjectToString(parent._af_mode.Get((int)(BA.ObjectToNumber(parent._getfromcapturerequest((Object)(parent._previewrequest.getObject()),"CONTROL_AF_MODE")))));
 //BA.debugLineNum = 273;BA.debugLine="Dim PreviewAEMode As String = AE_MODE.Get(GetFrom";
_previewaemode = BA.ObjectToString(parent._ae_mode.Get((int)(BA.ObjectToNumber(parent._getfromcapturerequest((Object)(parent._previewrequest.getObject()),"CONTROL_AE_MODE")))));
 //BA.debugLineNum = 274;BA.debugLine="If PreviewFocusMode = \"OFF\" Or PreviewFocusMode =";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 275;BA.debugLine="Log(\"Focus not supported\")";
parent.__c.LogImpl("69043972","Focus not supported",0);
 if (true) break;

case 5:
//C
this.state = 6;
 //BA.debugLineNum = 277;BA.debugLine="Dim PreviewBuilder As JavaObject = Camera.Create";
...
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreatePreviewBuilder()));
 //BA.debugLineNum = 278;BA.debugLine="PreviewSettingsMap.Put(\"CONTROL_AF_TRIGGER\", 1)";
parent._previewsettingsmap.Put((Object)("CONTROL_AF_TRIGGER"),(Object)(1));
 //BA.debugLineNum = 279;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSettin";
parent._setsettingsfrommap(_previewbuilder,parent._previewsettingsmap);
 //BA.debugLineNum = 280;BA.debugLine="Camera.AddCaptureRequest(PreviewBuilder)";
parent._camera.AddCaptureRequest((Object)(_previewbuilder.getObject()));
 //BA.debugLineNum = 281;BA.debugLine="Wait For (WaitForFocusWithTimeout(5000)) Complet";
...
;
 //BA.debugLineNum = 282;BA.debugLine="If Success = False Then";
if (true) break;
...
//C
this.state = 11;
 //BA.debugLineNum = 283;BA.debugLine="Log(\"Focus failed\")";
parent.__c.LogImpl("69043980","Focus failed",0);
 if (true) break;

case 10:
//C
this.state = 11;
 //BA.debugLineNum = 285;BA.debugLine="Log(\"Focused!\")";
parent.__c.LogImpl("69043982","Focused!",0);
 if (true) break;
...
this.state = 12;
;
 //BA.debugLineNum = 287;BA.debugLine="Wait For (TakePictureNow(MyTaskIndex)) Complete";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 288;BA.debugLine="Dim PreviewBuilder As JavaObject = Camera.Create";
_previewbuilder = new anywheresoftware.b4j.object.JavaObject();
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreatePreviewBuilder()));
 //BA.debugLineNum = 289;BA.debugLine="PreviewSettingsMap.Put(\"CONTROL_AF_TRIGGER\", 2)";
parent._previewsettingsmap.Put((Object)("CONTROL_AF_TRIGGER"),(Object)(2));
 //BA.debugLineNum = 290;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSettin";
parent._setsettingsfrommap(_previewbuilder,parent._previewsettingsmap);
 //BA.debugLineNum = 291;BA.debugLine="Camera.AddCaptureRequest(PreviewBuilder)";
parent._camera.AddCaptureRequest((Object)(_previewbuilder.getObject()));
 //BA.debugLineNum = 292;BA.debugLine="PreviewSettingsMap.Remove(\"CONTROL_AF_TRIGGER\")";
parent._previewsettingsmap.Remove((Object)("CONTROL_AF_TRIGGER"));
 //BA.debugLineNum = 293;BA.debugLine="Wait For (PreviewBuilder) Camera_CaptureComplete";
...
;
 //BA.debugLineNum = 294;BA.debugLine="Return data";
if (true) {
...
this.state = -1;
;
 //BA.debugLineNum = 296;BA.debugLine="Wait For (TakePictureNow(MyTaskIndex)) Complete (";
parent.__c.WaitFor("complete", ba, this, parent._takepicturenow(_mytaskindex));
this.state = 16;
return;
case 16:
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 297;BA.debugLine="Return data";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_data));return;};
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper  _getactivearraysize() throws Exception{
 //BA.debugLineNum = 260;BA.debugLine="Public Sub getActiveArraySize As Rect";
 //BA.debugLineNum = 261;BA.debugLine="Return GetFromCameraCharacteristic(\"SENSOR_INFO_A";
...
public String  _getautoexposuremode() throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Public Sub getAutoExposureMode As String";
 //BA.debugLineNum = 240;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _getcontrolmode() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Public Sub getControlMode As String";
 //BA.debugLineNum = 244;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _geteffectmode() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Public Sub getEffectMode As String";
 //BA.debugLineNum = 196;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public String  _getfocusmode() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Public Sub getFocusMode As String";
 //BA.debugLineNum = 221;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
int _front = 0;
int _orientation = 0;
 //BA.debugLineNum = 118;BA.debugLine="Private Sub GetHintOrientation As Int";
 //BA.debugLineNum = 119;BA.debugLine="Dim SensorOrientation As Int = GetFromCameraChara";
_sensororientation = (int)(BA.ObjectToNumber(_getfromcameracharacteristic("SENSOR_ORIENTATION")));
 //BA.debugLineNum = 120;BA.debugLine="Dim front As Int = -1";
_front = (int) (-1);
 //BA.debugLineNum = 121;BA.debugLine="If getIsFrontFacingCamera Then front = 1";
if (_getisfrontfacingcamera()) { 
_front = (int) (1);};
 //BA.debugLineNum = 122;BA.debugLine="Dim orientation As Int = (SensorOrientation + jca";
_orientation = (int) ((_sensororientation+(double)(BA.ObjectToNumber(_jcamera.GetField("lastKnownOrientation")))*_front+360)%360);
 //BA.debugLineNum = 123;BA.debugLine="Return orientation";
...
public boolean  _getisfrontfacingcamera() throws Exception{
 ...
 //BA.debugLineNum = 384;BA.debugLine="Return GetFromCameraCharacteristic(\"LENS_FACING\")";
...
public float  _getmaxdigitalzoom() throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Public Sub getMaxDigitalZoom As Float";
 //BA.debugLineNum = 230;BA.debugLine="Return GetFromCameraCharacteristic(\"SCALER_AVAILA";
...
public String  _getscenemode() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Public Sub getSceneMode As String";
 //BA.debugLineNum = 188;BA.debugLine="Return IntToConst(GetFromCaptureRequest(PreviewRe";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedautoexposuremodes() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Public Sub getSupportedAutoExposureModes As List";
 //BA.debugLineNum = 235;BA.debugLine="Return IntsToConstsList(GetFromCameraCharacterist";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedcapturesizes() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Public Sub getSupportedCaptureSizes As List";
 //BA.debugLineNum = 172;BA.debugLine="Return Camera.GetSupportedCaptureSizes(id)";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedeffectmodes() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Public Sub getSupportedEffectModes As List";
 //BA.debugLineNum = 200;BA.debugLine="Return IntsToConstsList(GetFromCameraCharacterist";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedfocusmodes() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Public Sub getSupportedFocusModes As List";
 //BA.debugLineNum = 204;BA.debugLine="Return RemoveDuplicates(IntsToConstsList(GetFromC";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 83;BA.debugLine="Public Sub getSupportedHardwareLevel As String";
 //BA.debugLineNum = 84;BA.debugLine="Dim jo As JavaObject = Camera.GetCameraCharacteri";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.GetCameraCharacteristics(BA.NumberToString(0))));
 //BA.debugLineNum = 85;BA.debugLine="Return IntToConst(jo.RunMethod(\"get\", Array(Stati";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedpreviewsizes() throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Public Sub getSupportedPreviewSizes As List";
 //BA.debugLineNum = 168;BA.debugLine="Return Camera.GetSupportedPreviewSizes(id)";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedscenemodes() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Public Sub getSupportedSceneModes As List";
 //BA.debugLineNum = 180;BA.debugLine="Return RemoveDuplicates(IntsToConstsList(GetFromC";
...
public anywheresoftware.b4a.objects.collections.List  _getsupportedvideosizes() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Public Sub getSupportedVideoSizes As List";
 //BA.debugLineNum = 176;BA.debugLine="Return Camera.GetSupportedVideoSizes(id)";
...
innerInitialize(_ba);
 //BA.debugLineNum = 36;BA.debugLine="Public Sub Initialize (CameraPanel As Panel)";
 //BA.debugLineNum = 37;BA.debugLine="mPanel = CameraPanel";
_mpanel = _camerapanel;
 //BA.debugLineNum = 38;BA.debugLine="Camera.Initialize(\"Camera\")";
_camera.Initialize(ba,"Camera");
 //BA.debugLineNum = 39;BA.debugLine="jcamera = Camera";
_jcamera = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera));
 //BA.debugLineNum = 40;BA.debugLine="PreviewSize.Initialize(640, 480)";
_previewsize.Initialize((int) (640),(int) (480));
 //BA.debugLineNum = 41;BA.debugLine="CaptureSize.Initialize(1920, 1080)";
_capturesize.Initialize((int) (1920),(int) (1080));
 //BA.debugLineNum = 42;BA.debugLine="StaticCaptureRequest.InitializeStatic(\"android.ha";
_staticcapturerequest.InitializeStatic("android.hardware.camera2.CaptureRequest");
 //BA.debugLineNum = 43;BA.debugLine="StaticCameraCharacteristics.InitializeStatic(\"and";
_staticcameracharacteristics.InitializeStatic("android.hardware.camera2.CameraCharacteristics");
 //BA.debugLineNum = 44;BA.debugLine="StaticCaptureResult.InitializeStatic(\"android.har";
_staticcaptureresult.InitializeStatic("android.hardware.camera2.CaptureResult");
 //BA.debugLineNum = 45;BA.debugLine="PreviewSettingsMap.Initialize";
_previewsettingsmap.Initialize();
 //BA.debugLineNum = 46;BA.debugLine="CaptureSettingMap.Initialize";
_capturesettingmap.Initialize();
 //BA.debugLineNum = 47;BA.debugLine="bothMaps = Array(PreviewSettingsMap, CaptureSetti";
...
__c.LogImpl("69895945",BA.ObjectToString(_consts),0);
 //BA.debugLineNum = 425;BA.debugLine="Log(\"Unknown consts: \" & mode)";
__c.LogImpl("69895946","Unknown consts: "+BA.NumberToString(_mode),0);
 };
 }
};
...
__c.LogImpl("69830406",BA.ObjectToString(_consts),0);
 //BA.debugLineNum = 410;BA.debugLine="Log(\"Unknown const: \" & i)";
__c.LogImpl("69830407","Unknown const: "+BA.NumberToString(_i),0);
...
public ResumableSub_OpenCamera(b4a.SapyLiveSystem.camex2 parent,boolean _front) {
this.parent = parent;
this._front = _front;
}
b4a.SapyLiveSystem.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 53;BA.debugLine="TaskIndex = TaskIndex + 1";
parent._taskindex = (int) (parent._taskindex+1);
 //BA.debugLineNum = 54;BA.debugLine="If Camera.IsCameraOpen Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 55;BA.debugLine="Stop";
parent._stop();
 if (true) break;
...
this.state = 5;
;
 //BA.debugLineNum = 57;BA.debugLine="mFront = Front";
parent._mfront = _front;
 //BA.debugLineNum = 58;BA.debugLine="id = Camera.FindCameraId(mFront)";
parent._id = parent._camera.FindCameraId(parent._mfront);
 //BA.debugLineNum = 59;BA.debugLine="If id = \"\" Then";
if (true) break;
...
//C
this.state = 8;
 //BA.debugLineNum = 60;BA.debugLine="Log(\"Camera not found.\")";
parent.__c.LogImpl("67012360","Camera not found.",0);
 //BA.debugLineNum = 61;BA.debugLine="id = Camera.CameraIDs(0)";
...
this.state = 9;
;
 //BA.debugLineNum = 63;BA.debugLine="Camera.OpenCamera(id)";
parent._camera.OpenCamera(parent._id);
 //BA.debugLineNum = 64;BA.debugLine="Wait For Camera_CameraState (Open As Boolean)";
...
;
 //BA.debugLineNum = 65;BA.debugLine="If Open = False Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 66;BA.debugLine="Log(\"Failed to open camera\")";
parent.__c.LogImpl("67012366","Failed to open camera",0);
 //BA.debugLineNum = 67;BA.debugLine="Return 0";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(0));return;};
 if (true) break;
;
 //BA.debugLineNum = 69;BA.debugLine="If PrintKeys Then PrintAllKeys(Camera.GetCameraCh";
...
this.state = -1;
;
 //BA.debugLineNum = 70;BA.debugLine="Return TaskIndex";
if (true) {
...
public ResumableSub_PrepareSurface(b4a.SapyLiveSystem.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
b4a.SapyLiveSystem.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 91;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 92;BA.debugLine="CloseSession";
parent._closesession();
 //BA.debugLineNum = 93;BA.debugLine="Wait For (CreateSurface) Complete (Result As Bool";
...
;
 //BA.debugLineNum = 94;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 13;
;
 //BA.debugLineNum = 95;BA.debugLine="Camera.StartSession(tv, PreviewSize, CaptureSize,";
parent._camera.StartSession((android.view.TextureView)(parent._tv.getObject()),parent._previewsize,parent._capturesize,(int) (256),(int) (0),parent.__c.False);
 //BA.debugLineNum = 96;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
...
_success = (Boolean) result[0];
;
 //BA.debugLineNum = 97;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 98;BA.debugLine="Return Success";
if (true) {
...
public ResumableSub_PrepareSurfaceForVideo(b4a.SapyLiveSystem.camex2 parent,int _mytaskindex,String _dir,String _filename) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
this._dir = _dir;
...
//C
this.state = 1;
 //BA.debugLineNum = 105;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 106;BA.debugLine="CloseSession";
parent._closesession();
 //BA.debugLineNum = 107;BA.debugLine="Wait For (CreateSurface) Complete (Result As Bool";
parent.__c.WaitFor("complete", ba, this, parent._createsurface());
this.state = 19;
return;
case 19:
...
_result = (Boolean) result[0];
;
 //BA.debugLineNum = 108;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 13;
;
 //BA.debugLineNum = 109;BA.debugLine="File.Delete(Dir, FileName)";
parent.__c.File.Delete(_dir,_filename);
 //BA.debugLineNum = 110;BA.debugLine="MediaRecorder = Camera.CreateMediaRecorder(Previe";
parent._mediarecorder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateMediaRecorder(parent._previewsize,_dir,_filename)));
 //BA.debugLineNum = 111;BA.debugLine="MediaRecorder.RunMethod(\"setOrientationHint\", Arr";
parent._mediarecorder.RunMethod("setOrientationHint",new Object[]{(Object)(parent._gethintorientation())});
 //BA.debugLineNum = 112;BA.debugLine="Camera.StartSession(tv, PreviewSize, CaptureSize,";
parent._camera.StartSession((android.view.TextureView)(parent._tv.getObject()),parent._previewsize,parent._capturesize,(int) (0),(int) (0),parent.__c.True);
 //BA.debugLineNum = 113;BA.debugLine="Wait For Camera_SessionConfigured (Success As Boo";
parent.__c.WaitFor("camera_sessionconfigured", ba, this, null);
this.state = 20;
return;
case 20:
...
_success = (Boolean) result[0];
;
 //BA.debugLineNum = 114;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 115;BA.debugLine="Return Success";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_success));return;};
...
__c.LogImpl("610092545",("******  "+__c.SmartStringFormatter("",(Object)(_title))+" **********"),0);
...
__c.LogImpl("610092563",(""+__c.SmartStringFormatter("",_k.RunMethod("getName",(Object[])(__c.Null)))+": "+__c.SmartStringFormatter("",_value)+""),0);
 }
};
...
String _f = "";
 //BA.debugLineNum = 207;BA.debugLine="Private Sub RemoveDuplicates(Raw As List) As List";
 //BA.debugLineNum = 208;BA.debugLine="Dim unique As Map";
_unique = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 209;BA.debugLine="unique.Initialize";
_unique.Initialize();
 //BA.debugLineNum = 210;BA.debugLine="For Each f As String In Raw";
{
...
_f = BA.ObjectToString(group3.Get(index3));
 //BA.debugLineNum = 211;BA.debugLine="unique.Put(f, \"\")";
_unique.Put((Object)(_f),(Object)(""));
 }
};
 //BA.debugLineNum = 213;BA.debugLine="Raw.Clear";
_raw.Clear();
 //BA.debugLineNum = 214;BA.debugLine="For Each f As String In unique.Keys";
{
...
_f = BA.ObjectToString(group7.Get(index7));
 //BA.debugLineNum = 215;BA.debugLine="Raw.Add(f)";
_raw.Add((Object)(_f));
 }
};
 //BA.debugLineNum = 217;BA.debugLine="Return Raw";
if (true) return _raw;
 //BA.debugLineNum = 218;BA.debugLine="End Sub";
return null;
}
public String  _setautoexposuremode(String _mode) throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Public Sub setAutoExposureMode (Mode As String)";
 //BA.debugLineNum = 247;BA.debugLine="SetBothMaps(\"CONTROL_AE_MODE\", AE_MODE.IndexOf(Mo";
_setbothmaps("CONTROL_AE_MODE",(Object)(_ae_mode.IndexOf((Object)(_mode))));
 //BA.debugLineNum = 248;BA.debugLine="PreviewSettingsMap.Put(\"FLASH_MODE\", FLASH_MODE.I";
_previewsettingsmap.Put((Object)("FLASH_MODE"),(Object)(_flash_mode.IndexOf((Object)("OFF"))));
 //BA.debugLineNum = 249;BA.debugLine="If Mode = \"ON_ALWAYS_FLASH\" Then";
if ((_mode).equals("ON_ALWAYS_FLASH")) { 
 //BA.debugLineNum = 250;BA.debugLine="CaptureSettingMap.Put(\"FLASH_MODE\", FLASH_MODE.I";
...
anywheresoftware.b4a.objects.collections.Map _m = null;
 //BA.debugLineNum = 264;BA.debugLine="Private Sub SetBothMaps(Key As String, Value As Ob";
 //BA.debugLineNum = 265;BA.debugLine="For Each m As Map In bothMaps";
...
_m = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (java.util.Map)(group1.Get(index1)));
 //BA.debugLineNum = 266;BA.debugLine="m.Put(Key, Value)";
...
public String  _seteffectmode(String _mode) throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Public Sub setEffectMode(Mode As String)";
 //BA.debugLineNum = 192;BA.debugLine="SetBothMaps(\"CONTROL_EFFECT_MODE\", EFFECT_MODE.In";
...
public String  _setfocusmode(String _mode) throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Public Sub setFocusMode(mode As String)";
 //BA.debugLineNum = 225;BA.debugLine="SetBothMaps(\"CONTROL_AF_MODE\", AF_MODE.IndexOf(mo";
...
public String  _setpreviewcropregion(anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _r) throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Public Sub setPreviewCropRegion(r As Rect)";
 //BA.debugLineNum = 256;BA.debugLine="PreviewSettingsMap.Put(\"SCALER_CROP_REGION\", r)";
...
public String  _setscenemode(String _mode) throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Public Sub setSceneMode(Mode As String)";
 //BA.debugLineNum = 184;BA.debugLine="SetBothMaps(\"CONTROL_SCENE_MODE\", SCENE_MODE.Inde";
...
anywheresoftware.b4j.object.JavaObject _previewbuilder = null;
 //BA.debugLineNum = 154;BA.debugLine="Public Sub StartPreview (MyTaskIndex As Int, Video";
 //BA.debugLineNum = 155;BA.debugLine="Dim PreviewBuilder As JavaObject";
_previewbuilder = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 156;BA.debugLine="If VideoRecording Then";
if (_videorecording) { 
 //BA.debugLineNum = 157;BA.debugLine="PreviewBuilder = Camera.CreateVideoRequestBuilde";
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.CreateVideoRequestBuilder()));
 ...
 //BA.debugLineNum = 159;BA.debugLine="PreviewBuilder = Camera.CreatePreviewBuilder";
_previewbuilder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.CreatePreviewBuilder()));
 ...
 //BA.debugLineNum = 161;BA.debugLine="SetSettingsFromMap(PreviewBuilder, PreviewSetting";
_setsettingsfrommap(_previewbuilder,_previewsettingsmap);
 //BA.debugLineNum = 162;BA.debugLine="PreviewRequest = Camera.SetRepeatingRequest(Previ";
_previewrequest = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.SetRepeatingRequest((Object)(_previewbuilder.getObject()))));
 //BA.debugLineNum = 163;BA.debugLine="If PrintKeys Then PrintAllKeys(PreviewRequest, \"P";
if (_printkeys) { 
...
public String  _startvideorecording(int _mytaskindex) throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Public Sub StartVideoRecording (MyTaskIndex As Int";
 //BA.debugLineNum = 128;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return";
if (_mytaskindex!=_taskindex) { 
if (true) return "";};
 //BA.debugLineNum = 129;BA.debugLine="MediaRecorder.RunMethod(\"start\", Null)";
_mediarecorder.RunMethod("start",(Object[])(__c.Null));
 //BA.debugLineNum = 130;BA.debugLine="RecordingVideo = True";
...
public String  _stopvideorecording(int _mytaskindex) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Public Sub StopVideoRecording (MyTaskIndex As Int)";
 //BA.debugLineNum = 135;BA.debugLine="CloseSession";
_closesession();
 //BA.debugLineNum = 136;BA.debugLine="Try";
try { //BA.debugLineNum = 137;BA.debugLine="MediaRecorder.RunMethod(\"stop\", Null)";
_mediarecorder.RunMethod("stop",(Object[])(__c.Null));
 } 
       catch (Exception e5) {
			ba.setLastException(e5); //BA.debugLineNum = 139;BA.debugLine="Log(LastException)";
__c.LogImpl("67471109",BA.ObjectToString(__c.LastException(ba)),0);
 };
 //BA.debugLineNum = 141;BA.debugLine="RecordingVideo = False";
_recordingvideo = __c.False;
...
public ResumableSub_TakePictureNow(b4a.SapyLiveSystem.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
b4a.SapyLiveSystem.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 317;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 318;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 319;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
...
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 320;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
 //BA.debugLineNum = 321;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
parent._setsettingsfrommap(_builder,parent._capturesettingmap);
 //BA.debugLineNum = 322;BA.debugLine="Dim CaptureRequest As Object = Camera.AddCaptureR";
_capturerequest = parent._camera.AddCaptureRequest((Object)(_builder.getObject()));
 //BA.debugLineNum = 323;BA.debugLine="If PrintKeys Then PrintAllKeys(CaptureRequest, \"C";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 324;BA.debugLine="Wait For Camera_PictureTaken (Data() As Byte)";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 325;BA.debugLine="StartPreview(MyTaskIndex, False)";
parent._startpreview(_mytaskindex,parent.__c.False);
 //BA.debugLineNum = 326;BA.debugLine="Return Data";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_data));return;};
...
public ResumableSub_TakePicturesNow(b4a.SapyLiveSystem.camex2 parent,int _mytaskindex,int _numberofpictures) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
...
//C
this.state = 1;
 //BA.debugLineNum = 336;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 337;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 338;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
_builder = new anywheresoftware.b4j.object.JavaObject();
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 339;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
...
//C
this.state = 13;
if ((step12 > 0 && _i <= limit12) || (step12 < 0 && _i >= limit12)) this.state = 12;
if (true) break;
...
public ResumableSub_WaitForFocusWithTimeout(b4a.SapyLiveSystem.camex2 parent,int _timeoutms) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 301;BA.debugLine="Dim start As Long = DateTime.Now";
_start = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 302;BA.debugLine="Do Until FocusState = \"FOCUSED_LOCKED\" Or FocusSt";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 303;BA.debugLine="Sleep(50)";
...
this.state = 4;
;
 //BA.debugLineNum = 304;BA.debugLine="If DateTime.Now - start > TimeoutMs Then Return";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 306;BA.debugLine="Return FocusState = \"FOCUSED_LOCKED\"";
if (true) {
