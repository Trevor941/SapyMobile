...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.SapyLiveSystem.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.SapyLiveSystem.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public b4a.SapyLiveSystem.b4xfloattextfield _searchfield = null;
...
_searchfield = new b4a.SapyLiveSystem.b4xfloattextfield();
...
__c.LogImpl("939387167","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(b4a.SapyLiveSystem.b4xsearchtemplate parent,b4a.SapyLiveSystem.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
b4a.SapyLiveSystem.b4xsearchtemplate parent;
