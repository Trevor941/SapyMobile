...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.SapyLiveSystem.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.SapyLiveSystem.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_BusyLoop(b4a.SapyLiveSystem.anotherprogressbar parent) {
this.parent = parent;
}
b4a.SapyLiveSystem.anotherprogressbar parent;
int _myindex = 0;
