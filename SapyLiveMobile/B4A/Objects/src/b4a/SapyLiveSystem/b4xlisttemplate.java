...
public class b4xlisttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.SapyLiveSystem.b4xlisttemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.SapyLiveSystem.b4xlisttemplate.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(b4a.SapyLiveSystem.b4xlisttemplate parent,b4a.SapyLiveSystem.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
b4a.SapyLiveSystem.b4xlisttemplate parent;
